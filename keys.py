...
statements = [
    ...
    },
    {
        'statement': 'ratios',
        'keys': {
            'Return on Assets %': 4178,
            'Return on Capital %': 43905,
            'Return On Equity %': 4128,
            'Return on Common Equity %': 33320,
            'Gross Profit Margin %': 4074,
            'SG&A Margin %': 4375,
            'EBITDA Margin %': 4047,
            'EBITA Margin %': 4419,
            'EBIT Margin %': 4053,
            'Income From Continuing Operations Margin %': 4181,
            'Net Income Margin %': 4094,
            'Normalized Net Income Margin %': 4420,
            'Net Avail. For Common Margin %': 4182,
            'Levered Free Cash Flow Margin %': 4436,
            'Unlevered Free Cash Flow Margin %': 4437,
            'Asset Turnover': 43917,
            'Fixed Assets Turnover': 4066,
            'Receivables Turnover': 4001,
            'Inventory Turnover': 4082,
            'Working Capital Turnover': 43913,
            'Current Ratio': 4030,
            'Quick Ratio': 4121,
            'Op Cash Flow to Current Liab': 4185,
            'Avg. Cash Conversion Cycle': 4184,
            'Avg. Days Sales Outstanding': 4042,
            'Avg. Days Outstanding Inventory': 4035,
            'Avg. Days Payable Outstanding': 4183,
            'Total Debt / Equity': 4034,
            'Total Debt / Capital': 43907,
            'Total Liabilities / Total Assets': 4188,
            'EBIT / Interest Expense': 4189,
            'EBITDA / Interest Expense': 4190,
            '(EBITDA - Capex) / Interest Expense': 4191,
            'FFO Interest Coverage': 43903,
            'FFO to Total Debt (x)': 43904,
            'Total Debt / EBITDA': 4192,
            'Net Debt / EBITDA': 4193,
            'Net Debt / (EBITDA - Capex)': 23314
        }
    },
    {
        'statement': 'multiples',
        'keys': {
            ...
            'NTM Price / Normalized Earnings (P/E)': '',
            'NTM Market Cap / Free Cash Flow': '',
            'NTM Levered Free Cash Flow Yield': '',
            ...
            'LTM Price / Diluted EPS Before Extra': '',
            ...
            'NTM Levered Free Cash Flow': '',
            'LTM Revenues': 28,
            'LTM Gross Profit': 10,
            'LTM EBITDA': 4051,
            'LTM EBIT': 21,
            'LTM Diluted EPS Before Extra': '',
            'LTM Book Value per Share': 4020,
            'LTM Tangible Book Value per Share': 4156,
